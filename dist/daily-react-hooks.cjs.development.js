...
var DailyIframe = _interopDefault(require('@daily-co/react-native-daily-js'));
...
var DailyParticipants = function DailyParticipants(_ref2) {
  ...
  var daily = useDaily();
  useDailyEvent('active-speaker-change', recoil.useRecoilCallback(function (_ref3) {
    var set = _ref3.set,
  ...
  var initParticipants = recoil.useRecoilCallback(function (_ref5) {
    var set = _ref5.set;
    return /*#__PURE__*/function () {
  ...
  useDailyEvent('joined-meeting', recoil.useRecoilCallback(function (_ref7) {
    var set = _ref7.set;
    return function (ev) {
      set(participantsState, function (prev) {
  ...
  useThrottledDailyEvent('participant-joined', recoil.useRecoilCallback(function (_ref8) {
    var set = _ref8.set;
    return /*#__PURE__*/function () {
  ...
  useThrottledDailyEvent('participant-updated', recoil.useRecoilCallback(function (_ref11) {
  ...
  useThrottledDailyEvent('participant-left', recoil.useRecoilCallback(function (_ref14) {
    var set = _ref14.set;
    return function (evts) {
      set(participantsState, function (prev) {
...
var useDevices = function useDevices() {
  ...
  useDailyEvent('error', recoil.useRecoilCallback(function (_ref12) {
...
var useInputSettings = function useInputSettings(_temp) {
  ...
  var errorMsg = recoil.useRecoilValue(errorState); // const daily = useDaily();
...
var useLocalParticipant = function useLocalParticipant() {
  ...
  var initState = recoil.useRecoilCallback(function (_ref) {
    var set = _ref.set;
...
var useNetwork = function useNetwork(_temp) {
  ...
  var getStats = React.useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
    var newStats;
    return runtime_1.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
